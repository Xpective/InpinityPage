...
--
-- Host: dbaas-db-5790554-do-user-14500968-0.b.db.ondigitalocean.com    Database: defaultdb
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '49a59546-374a-11ee-8569-66918d4a9194:1-43';
...
CREATE TABLE `apps` (
  ...
  `app_created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`app_id`)
...
INSERT INTO `features` VALUES (1,'Feature Titel','Feature Beschreibung','/path/to/image.jpg','2023-08-10','Benutzername',0,NULL);
...
CREATE TABLE `nfts` (
  ...
  `mint_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `solana_token_address` varchar(255) DEFAULT NULL,
...
CREATE TABLE `ratings` (
  ...
  CONSTRAINT `ratings_ibfk_2` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`id`),
  CONSTRAINT `ratings_ibfk_3` FOREIGN KEY (`reply_id`) REFERENCES `replies` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `replies` (
  ...
  CONSTRAINT `replies_ibfk_2` FOREIGN KEY (`thread_id`) REFERENCES `threads` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `sender_firebase_uid` varchar(255) NOT NULL,
  `receiver_firebase_uid` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2023-08-10 11:40:54
